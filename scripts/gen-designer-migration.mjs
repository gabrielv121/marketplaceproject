...
const items = JSON.parse(await readFile(path.join(root, "data", "designer-catalog.json"), "utf8"));
...
const sql = `-- Avant-garde / designer catalog (source: data/designer-catalog.json, npm run seed:designer)
...
const out = path.join(root, "supabase", "migrations", "20250515160000_catalog_designer_brands_seed.sql");
