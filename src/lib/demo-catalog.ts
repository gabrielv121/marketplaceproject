...
export const DEMO_PRODUCTS: CatalogProductSummary[] = [
  {
    ...
    homeRails: ["trending-sneakers", "popular-local", "new-at-vrna", "below-retail"],
  ...
  },
  {
    ...
    variantSizePreset: "apparel",
    homeRails: ["featured-apparel", "popular-local", "new-at-vrna"],
  ...
  },
  {
    ...
    homeRails: ["featured-accessories", "featured-apparel", "new-at-vrna"],
    activities: ["training"],
  ...
  },
  {
    ...
    variantSizePreset: "accessory",
    homeRails: ["featured-accessories", "below-retail", "new-at-vrna"],
    activities: ["training"],
  ...
  },
  {
    ...
    variantSizePreset: "shoe",
    homeRails: ["trending-sneakers", "popular-local", "new-at-vrna"],
    activities: ["soccer"],
  ...
  },
  {
    ...
    variantSizePreset: "shoe",
    homeRails: ["trending-sneakers", "new-at-vrna", "popular-local"],
    activities: ["tennis"],
